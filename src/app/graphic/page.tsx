      ...
      <div className='m-auto flex justify-evenly w-full h-[100px]'>
        ...
        <div className='ml-[100px] w-[88.5%] grid grid-cols-2 gap-5'>
          ...
          <div>
            ...
            <p className='text-[#00000099] max-w-prose'>"I absolutely love this t-shirt. The design is unique and the fabric is confortable. As a fellow designer, I appreciate the attention to detail. It's become my favorite go-to shirt
            <br /><br />
          ...
          <div>
            ...
            <p className='text-[#00000099] max-w-prose'>"The t-shirt exceeded my expectations! The colors are vibrant and the print quality is top-notch. Being a UI/UX designer myself, I'm quite picky about aesthetics, and this t-shirt definitely gets a thumbs up from me."
            <br /><br />
          ...
          <div>
            ...
            <p className='text-[#00000099] max-w-prose'>"This t-shirt is a must-have for anyone who appreciates good design. The minimalistic yet stylish pattern caught my eye, and the fit is perfect. I can see the designer's touch in every aspect of this shirt."
            <br /><br />
          ...
          <div>
            ...
            <p className='text-[#00000099] max-w-prose'>"As a UI/UX enthusiast, I value simplicity and functionality. This t-shirt not only represents those principles but also feels great to wear. It's evident that the designer poured their creativity into making this t-shirt stand out."
            <br /><br />
          ...
          <div>
            ...
            <p className='text-[#00000099] max-w-prose'>"This t-shirt is a fusion of comfort and creativity. The fabric is soft, and the design speaks volumes about the designer's skill. It's like wearing a piece of art that reflects my passion for both design and fashion."
            <br /><br />
          ...
          <div>
            ...
            <p className='text-[#00000099] max-w-prose'>"I'm not wearing a t-shirt; I'm wearing a piece of design philosophy. The intricate details and thoughtful layout of the design make this shirt a conversation starter."
            <br /><br />
